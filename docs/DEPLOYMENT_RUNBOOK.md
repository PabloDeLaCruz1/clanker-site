...
The Clanker Site project is connected and deployed merge commit `d36ffdb` successfully on July 26,
2026. The two prototype URLs still serve builds that predate the revival. Their project ownership,
Git connection, and production-branch settings require access to the Vercel account that owns them.

## Reconnect a prototype
